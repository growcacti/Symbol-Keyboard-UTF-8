...
bb444 = tk.Button(frm2, text='u\00A1', width=1,height=1,font=('arial',12,'bold'),bd=4,bg='lavender', command=char82)
...
bb4441.grid(row=11, column=12)
bb4451 = tk.Button(frm2, text='\u00AA', width=1,height=1,font=('arial',12,'bold'),bd=4,bg='lavender', command=char91)
bb4451.grid(row=10, column=12)
...
butt910 = tk.Button(frm2, text='\u00B3', width=1,height=1,font=('arial',12,'bold'),bd=4,bg='lavender', command=char100)
butt910.grid(row=10, column=11)
...
butt921 = tk.Button(frm2, text='\u00b4', width=1,height=1,font=('arial',12,'bold'),bd=4,bg='lavender', command=char101)
butt921.grid(row=11, column=11)
def char102():
  ur = '\u00b5'
  text.insert(tk.END, ur)
  return ur
  
butt931 = tk.Button(frm2, text='\u00b5', width=1,height=1,font=('arial',12,'bold'),bd=4,bg='lavender', command=char102)
butt931.grid(row=12, column=11)
def char103():
  ur = '\u00B6'
  text.insert(tk.END, ur)
  return ur
  
butt941 = tk.Button(frm2, text='\u00b6', width=1,height=1,font=('arial',12,'bold'),bd=4,bg='lavender', command=char103)
butt941.grid(row=13, column=11)
def char104():
  ur = '\u00bc'
  text.insert(tk.END, ur)
  return ur

butt951 = tk.Button(frm2, text='\u00bc', width=1,height=1,font=('arial',12,'bold'),bd=4,bg='lavender', command=char104)
butt951.grid(row=14, column=11)
def char105():
  ur = '\u00bd'
  text.insert(tk.END, ur)
  return ur
...
bu112 = tk.Button(frm2, text='\u00bd    ', width=1,height=1,font=('arial',12,'bold'),bd=4,bg='lavender', command=char105)
...
bu245 = tk.Button(frm2, text='\u00be', width=1,height=1,font=('arial',12,'bold'),bd=4,bg='lavender', command=char106)
...
bu332 = tk.Button(frm2, text='\u2211', width=1,height=1,font=('arial',12,'bold'),bd=4,bg='lavender', command=char107)
...
bu478 = tk.Button(frm2, text='\u2318', width=1,height=1,font=('arial',12,'bold'),bd=4,bg='lavender', command=char108)
